function generatePlane(formList) {
    ...
    formList.forEach((formItem) => {
        ...
        result += `
            <div class="auth-plane">
                <h2 class="auth-title">${formItem.title}</h2>

                <el-form :model="${prefix}FormData" :rules="${prefix}Rules" label-position="left" label-width="100px" ref="${prefix}Form">
